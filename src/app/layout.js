...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <body suppressHydrationWarning className="min-h-full flex flex-col bg-white dark:bg-slate-950 text-slate-950 dark:text-slate-100 transition-colors duration-300">
        <Providers>
          <Navbar />
