...
export default function UserProfile({ user, role = "Reader" }) {
  ...
  return (
    <div className="max-w-2xl rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
      <div className="mb-6 flex items-center justify-between border-b border-slate-800/60 pb-6">
        <div className="flex items-center gap-4">
          {/* Avatar Container */}
          <div className="h-16 w-16 overflow-hidden rounded-2xl border border-slate-700 bg-slate-800 shadow-inner">
            {user?.image ? (
              <Image
                src={user.image}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="group rounded-xl border border-slate-800/50 bg-slate-950 p-4 transition-colors hover:border-slate-800">
