...
export default function DataTable({
  ...
  return (
    <div className="overflow-y-auto overflow-x-hidden max-h-[calc(100vh-280px)] rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 scrollbar-hide [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
